...
- **Advanced Filtering**: Filter logs using LevelFilter, PrefixFilter, MetadataFilter, CompositeFilter, OrFilter, NotFilter, PredicateFilter, and FieldFilter with sophisticated logic.
...
- **HTTP Transport**: Send logs to remote HTTP/S endpoints with retry logic, timeout handling, and custom headers.
