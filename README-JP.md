...
2. **パフォーマンス**: 100,000回以上の反復で測定し、プロセス内の no-op シンクを使用。詳細な測定条件と最新結果は [Benchmarks](./docs/benchmarks-JP.md) を参照してください。
...
| **処理速度 (単純ログ)** | 2.89M ops/sec | 2.89M ops/sec | 987k ops/sec | 209k ops/sec |
| **処理速度 (メタデータ付)** | 1.13M ops/sec | 1.13M ops/sec | 485k ops/sec | 108k ops/sec |
